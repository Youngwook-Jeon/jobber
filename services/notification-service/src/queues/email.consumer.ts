...
async function consumeAuthEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    log.log('error', 'NotificationService\'s emailConsumer consumeOrderEmailMessages() method error:', error);
  }
}
...
async function consumeOrderEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    log.log('error', 'NotificationService\'s emailConsumer consumeAuthEmailMessages() method error:', error);
  }
}

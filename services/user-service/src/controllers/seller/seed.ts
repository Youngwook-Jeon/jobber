...
import { BadRequestError, IBuyerDocument, IEducation, IExperience, ISellerDocument } from '@youngwook-jeon/jobber-shared';
...
const seed = async (req: Request, res: Response): Promise<void> => {
  ...
  for (let i = 0; i < buyers.length; i++) {
    ...
    const seller: ISellerDocument = {
      ...
      socialLinks: ['https://google.com', 'http://youtube.com', 'https://facebook.com'],
      certificates: [
        {

...
import { IBuyerDocument, ISellerDocument, winstonLogger } from '@youngwook-jeon/jobber-shared';
...
const consumeReviewFanoutMessages = async (channel: Channel): Promise<void> => {
  try {
    ...
    log.log('error', 'UserService UserConsumer consumeReviewFanoutMessages() method error:', error);
  }
};

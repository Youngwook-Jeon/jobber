import { IHitsTotal, IPaginateProps, IQueryList, ISearchResult } from '@youngwook-jeon/jobber-shared';
    ...
    query: {
      bool: {
        filter: {
          script: {
            script: {
              source: 'doc[\'ratingsCount\'].value != 0 && (doc[\'ratingSum\'].value / doc[\'ratingsCount\'].value == params[\'threshold\'])',
              lang: 'painless',
              params: {
                threshold: 5
              }

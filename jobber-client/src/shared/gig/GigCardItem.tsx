...
import { IGigsProps, ISellerGig } from 'src/features/gig/interfaces/gig.interface';
import { useDeleteGigMutation, useUpdateActiveGigMutation } from 'src/features/gig/services/gig.service';

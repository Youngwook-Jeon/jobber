...
import { ICreateGig, ISellerGig } from 'src/features/gig/interfaces/gig.interface';
...
import { IEducation, IExperience, ILanguage, IPersonalInfoData, ISellerDocument } from 'src/features/seller/interfaces/seller.interface';

...
import { IGigInfo } from 'src/features/gig/interfaces/gig.interface';
import { IProfileHeaderProps, ISellerProfileItem, IShowEditItem } from 'src/features/seller/interfaces/seller.interface';

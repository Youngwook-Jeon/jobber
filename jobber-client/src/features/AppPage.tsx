...
import { useGetSellerByUsernameQuery } from './seller/services/seller.service';
...
const AppPage: FC = (): ReactElement => {
  ...
  }, [currentUserData, appLogout, dispatch, buyerData?.buyer, sellerData?.seller, authUser.username, navigate]);
